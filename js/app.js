...
/* update total balance and price also */
let count = 0;
...
const getInputValue = (id) => {
  ...
  const converted = parseFloat(element);/* total decimal parseint bug is ok */
  return converted;
};
...
/*for  modal  */
const modal=()=>{
  confirm(`DO YOU WANT TO BUY THIS PRODUCTS`)
}
